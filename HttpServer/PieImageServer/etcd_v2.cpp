...
EtcdV2::EtcdV2(std::string host, std::string port) : host_(host), port_(port)
{

}

bool EtcdV2::SetValue(const std::string& key, const std::string& value, bool set_ttl)
{
    try
    {
        std::string value1;
...
bool EtcdV2::GetValue(const std::string& key, std::string& value)
{
    try
    {
...
bool EtcdV2::Delete(const std::string& key)
{
    try
    {
        std::string value;
...
void EtcdV2::HttpRequest(const std::string& host, const std::string& port, const std::string& target, http::verb op, std::string& value)
{
    int version = 11;
